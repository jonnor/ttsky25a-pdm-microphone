...
"""
MicroPython script to flash the FPGA on a pico-ice (via RP2040)

MicroPython must already be installed and running on RP2020.

From
https://github.com/MichaelBell/tinyQV/blob/main/pico_ice/micropython/fpga_flash_prog.py 
"""
